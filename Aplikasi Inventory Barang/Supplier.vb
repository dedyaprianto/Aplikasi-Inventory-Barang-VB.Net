...
Public Class Supplier
    ...
    Sub tampil()
        koneksi()
        da = New MySqlDataAdapter("SELECT * FROM supplier ", conn)
        ds = New DataSet
        da.Fill(ds, "supplier")
    ...
    Private Sub Guna2Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guna2Button1.Click
        ...
        Else
            ...
            End If
            Dim simpan As String = "INSERT INTO supplier VALUES ('" & TextBox1.Text & "','" & TextBox2.Text & "','" & jk & "','" & TextBox3.Text & "','" & TextBox4.Text & "') "
    ...
    Private Sub Guna2Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guna2Button2.Click
        If MessageBox.Show("Apakah Anda Ingin Merubah Data supplier", "konfirmasi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
            If TextBox1.Text = "" Or TextBox2.Text = "" Or TextBox3.Text = "" Or TextBox4.Text = "" Then
                MsgBox("Silahkan Isi Formnya")
            Else
                koneksi()
                ...
                End If
                Dim edit As String
                edit = "UPDATE supplier SET nama_supplier = '" & TextBox2.Text & "',jk_supplier = '" & jk & "', alamat_supplier = '" & TextBox3.Text & "', telepon_supplier = '" & TextBox4.Text & "' WHERE id_supplier= '" & TextBox1.Text & "' "
    ...
    Private Sub Guna2Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guna2Button3.Click
        ...
        Else
            koneksi()
            Dim hapus As String
            hapus = "DELETE FROM supplier WHERE id_supplier='" & TextBox1.Text & "'"
    ...
    Private Sub Guna2Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Guna2Button5.Click
        ...
        Else
            Dim cari As String
            cari = "SELECT * FROM supplier WHERE id_supplier LIKE '%" & TextBox5.Text & "%' OR nama_supplier LIKE '%" & TextBox5.Text & "%' "
